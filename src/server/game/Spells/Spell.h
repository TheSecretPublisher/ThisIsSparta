...
class Spell
{
    ...
    public:
        ...
        // Follow the spell_hun_camouflage_ignore script for its usage. DO NOT USE it with any other hook or the server will crash when pressing Esc after the cast
