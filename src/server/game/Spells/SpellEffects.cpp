        ...
        case SPELLFAMILY_HUNTER:
            switch (m_spellInfo->Id)
            {
                ...
                case 56641:
                {
                    ...
                    if (AuraEffect* aurEff = m_caster->GetDummyAuraEffect(SPELLFAMILY_HUNTER, 2008, EFFECT_0))
                    {
            ...
            switch (m_spellInfo->Id)
            {
                ...
                case 99489:
                {
                    if(unitTarget && unitTarget->GetMap()->IsHeroic())
                    {
                        ...
                        {
                            if(!unitTarget->HasAura(aurEff->GetId()))
                            {
                                m_caster->CastSpell(unitTarget, aurEff->GetId(), true);
                            }
                        }
                    }
                    break;  
