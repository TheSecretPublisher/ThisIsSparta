...
class BattlegroundSA : public Battleground
{
    ...
    private:
        ...
        /// Set selectable or not gun, called on battle start, when boats arrive to dock
        void GunStartState(bool start);
        /// Set selectable or not bomb, called on battle start, when boats arrive to dock
        void BombStartState(bool start);
        /**
