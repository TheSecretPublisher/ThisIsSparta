...
public:
    ...
    struct boss_lady_nazjarAI : public ScriptedAI
    {
        ...
        {
			me->MonsterTextEmote(RAND(SAY_KILL_1,SAY_KILL_2),NULL);
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            if (me->HealthBelowPct(67) && Phase == PHASE_NORMAL && PhaseCount == 0)
            {
                ...
                me->TextEmote(SAY_66_PRECENT,NULL);
            ...
            {
                me->ApplySpellImmune(0, IMMUNITY_MECHANIC, MECHANIC_INTERRUPT, true);
                me->TextEmote(SAY_33_PRECENT,NULL);
