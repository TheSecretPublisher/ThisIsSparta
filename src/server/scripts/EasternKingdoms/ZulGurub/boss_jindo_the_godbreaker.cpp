        ...
        struct boss_jindo_the_godbreakerAI : public BossAI
        {
            ...
            void JustSummoned(Creature* summoned)
            {
                switch (summoned->GetEntry())
                {
                    ...
                    case 52430:
                        summoned->SetPhaseMask(2, true);
                        summoned->CastSpell((Unit*)NULL, 97022, false);
                        break;
                }
                ...
                if (action == ACTION_CHAIN_DIED)
                {
                    ...
                    if (ChainCount == 3)
                    {
                        ...
                        if (Creature* hakkar = ObjectAccessor::GetCreature(*me, HakkarGUID))
                        {
                            ...
                            hakkar->CastSpell(hakkar, 97209, false);
                ...
                if (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SPIRIT_WORLD:
                            me->CastSpell(me, 100401, false);
                            me->CastSpell(me, 98861, false);
                            me->CastSpell(me, 97002, false);
    ...
    private:
        ...
        struct boss_jindo_the_godbreaker_spirit_worldAI : public ScriptedAI
        {
            ...
            void SpellHitTarget(Unit* target, const SpellInfo* spell)
            {
                ...
                {
                    case 97158:
                        me->CastSpell(target, RightArm ? 97160 : 97208, true);
                        RightArm = !RightArm;
                        break;
                    case 97152:
                        target->CastSpell(target, 97123, false, NULL, NULL, me->ToTempSummon()->GetSummonerGUID());
                        break;
                }
            }
            ...
            void UpdateAI(uint32 diff)
            {
                ...
                {
                    me->CastSpell((Unit*)NULL, 97152, false);
                    me->CastSpell((Unit*)NULL, 97158, false);
        ...
        if (uint32 eventId = events.ExecuteEvent())
        {
            switch (eventId)
            {
                case EVENT_BODY_SLAM:
                    me->CastSpell((Unit*)NULL, 97597, false);
                    events.ScheduleEvent(EVENT_BODY_SLAM, urand(10000, 20000));
                    break;
                case EVENT_FRENZY:
                    me->CastSpell(me, 97088, false);
                    events.ScheduleEvent(EVENT_FRENZY, urand(7000, 14000));
                    break;
            }
        }
