...
public:
    ...
    {
        mob_seed_of_chaosAI(Creature* creature) : ScriptedAI(creature), Summons(me)
        {
...
public:
    ...
    struct mob_choas_portalAI : public ScriptedAI
    {
        mob_choas_portalAI(Creature* creature) : ScriptedAI(creature), Summons(me)
        {
            m_pInstance = (InstanceScript*)creature->GetInstanceScript();
            Reset();
        }
