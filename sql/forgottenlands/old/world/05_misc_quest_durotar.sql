...
DELETE FROM `gameobject_loot_template` WHERE (`entry`=205076);
...
DELETE FROM `gameobject_loot_template` WHERE (`entry`=202648);
...
DELETE FROM `creature_loot_template` WHERE `entry`=3195 AND `item`=52564;
INSERT INTO `creature_loot_template` (`entry`,`item`,`ChanceOrQuestChance`) VALUES (3195,52564,50);
DELETE FROM `creature_loot_template` WHERE `entry`=3199 AND `item`=52564;
INSERT INTO `creature_loot_template` (`entry`,`item`,`ChanceOrQuestChance`) VALUES (3199,52564,50);
DELETE FROM `creature_loot_template` WHERE `entry`=3196 AND `item`=52564;
...
DELETE FROM `smart_scripts` WHERE `entryorguid`=39351;
...
DELETE FROM `smart_scripts` WHERE `entryorguid`=39352;
