-- Add Twin peaks to battleground tab
...
-- Delete DB gameobject spawns for Twin Peaks
DELETE FROM `gameobject` WHERE `map` = 726;

-- Delete DB creature spawns (Spirit guides) for Twin Peaks
