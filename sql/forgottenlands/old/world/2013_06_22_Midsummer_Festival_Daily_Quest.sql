...
DELETE FROM `creature` WHERE `guid` IN ('14500000');
INSERT INTO `creature` VALUES (14500000, 26221, 0, 1, 3969, 0, 1, -8829.94, 868.132, 98.7883, 4.67871, 300, 0, 0, 8982, 3155, 0, 0, 0, 0);
DELETE FROM `game_event_creature` WHERE (`guid`='14500000');
INSERT INTO `game_event_creature` (`eventEntry`, `guid`) VALUES ('1', '14500000');